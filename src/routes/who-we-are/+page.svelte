<script lang="ts">
	...
	const teamMembers: {
	...
	}[] = [
		{
			...
			role: 'Co-Founder',
			description:
				'Ryan is a rising senior at MIT, US. In addition to excelling in math competitions and enjoying fantasy football, he is passionate about serving his community and helping underprivileged children around the world. He is committed to making a positive impact wherever he goes.',
		...
		},
		{
			...
			role: 'Co-Founder',
			description:
				'James is a rising senior with a passion for computer science and a talent for developing technology that connects people at UIUC, US. As the program director for Project Given, he is committed to using his skills and knowledge to support and empower children around the globe.',
		...
		>
			{#each teamMembers as member}
				<div class="flex max-w-[400px] flex-col items-center gap-1">
					...
					<span class="-mt-1 mb-1 text-lg">{member.role}</span>
