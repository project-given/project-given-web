...
<div class="flex h-12 w-screen flex-row items-center justify-end gap-12 bg-white px-12 shadow">
	{#each navigationItems as { name, urls, onClick }}
		<NavbarItem {name} {urls} {onClick} />
	{/each}
</div>
