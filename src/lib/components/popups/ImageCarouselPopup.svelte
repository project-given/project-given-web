	...
	>
		...
		>
			...
			<div class="relative h-full w-full">
				...
				<div
					class="absolute inset-x-0 top-0 flex h-16 flex-row justify-end bg-gradient-to-b from-black to-transparent sm:opacity-0"
				>
					<div
						class="m-3 h-5 w-5 cursor-pointer text-center"
